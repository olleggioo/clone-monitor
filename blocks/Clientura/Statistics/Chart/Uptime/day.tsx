...
import { StatsFilterStateI, atomPeriodFromToCharts, statsFilterAtom } from '@/atoms/statsAtom'
...
const OneDayUptimeChartClients: FC<{ 
...
export default OneDayUptimeChartClients
